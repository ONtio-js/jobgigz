			...
			<div class="row">
				<div class="col-lg-4 col-md-3 col-12">
					<div class="form-group mb-0">
						<input class="search-1" type="text"
				...
				<div class="col-lg-2 col-md-3 col-12 mt-15">
					<button class="srch-btn" type="submit">Search Now {{session()->get('companyId')}}</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12">
					<ul class="post-buttons">
						<li><button class="add-job" onclick="window.location.href = '/jobs/create';">Post a
								Job</button></li>
						<li><button class="add-project"
								onclick="window.location.href = '/jobs';">Browse Jobs</button></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="offer-step">
						<div class="offer-text-dt">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur dictum commodo mi.
							</p>
				...
				<div class="col-md-12 col-12">
					<div class="lts-jobs-slider">
							...
							<div class="item">
								<div class="job-item">
									...
									<div class="job-buttons">
										<ul class="link-btn">
											<li><a href="#" class="link-j1" title="Apply Now">APPLY NOW</a>
											</li>
											<li><a href="job_single_view.html" class="link-j1"
						...
						<div class="text-center">
							<button class="view-links" onclick="window.location.href = '/jobs';">BROWSE ALL
								JOBS</button>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-12 col-12">
					<div class="lts-jobs-slider">
						<div class="owl-carousel jobs-owl owl-theme">
							<div class="item">
								<div class="job-item">
									...
									<div class="job-buttons">
										<ul class="link-btn">
											<li><a href="other_freelancer_profile.html" class="link-j1"
													title="View Profile">View Profile</a></li>
											<li><a href="#" class="link-j1" title="Hire Me">Hire Me</a>
											</li>
											<li class="bkd-pm"><button class="bookmark1" title="bookmark"><i
														class="fas fa-heart"></i></button></li>
										</ul>
						...
						<div class="text-center">
							<button class="view-links" onclick="window.location.href = '/search';">SEE ALL
								CANDIDATES</button>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-12">
					...
					<div class="text-steps">
						...
						<div class="btns15">
							<button class="btn-152"
								onclick="window.location.href = 'browse_freelancers.html';">Get Listed</button>
							<button class="btn-153" onclick="window.location.href = '#';">Learn More</button>
						</div>
					</div>
				</div>
