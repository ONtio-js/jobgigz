			...
			<div class="row">
				<div class="col-lg-6">
					<div class="contact_dts">
						...
						<ul class="cinfo10">
							<li>
								<p><span><i class="fas fa-map-marker-alt"></i>Address :</span>#1234, Sks Nagar,
									Near MBD Mall, 141001 Ludhiana, Punjab, India</p>
							</li>
							<li>
								<p><span><i class="fas fa-envelope"></i>Email Address :</span><a
										href="https://gambolthemes.net/cdn-cgi/l/email-protection"
										class="__cf_email__"
										data-cfemail="e3b09693938c9197a3898c81819acd808c8e">[email&#160;protected]</a>
								</p>
							</li>
						</ul>
					</div>
