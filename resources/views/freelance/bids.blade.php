						...
						<div class="col-lg-3">
							<div class="jobs_tabs">
								<ul class="nav job_nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" href="#manage_bids" id="manage-bids-tab"
											data-toggle="tab">Manage Bids</a>
									</li>
									<li class="nav-item job_nav_item">
										<a class="nav-link" href="#manage_bidders" id="manage-bidders-tab"
											data-toggle="tab">Manage Bidders</a>
									</li>
									<li class="nav-item job_nav_item">
										<a class="nav-link" href="#active_bids" id="active-bids-tab"
											data-toggle="tab">My Active Bids</a>
									</li>
									<li class="nav-item job_nav_item">
										<a class="nav-link" href="#post_project" id="post-project-tab"
											data-toggle="tab">Post a Project</a>
									</li>
								</ul>
							</div>
						</div>
											...
											<ul class="all_applied_jobs jobs_bookmarks">
												<li>
													<div class="applied_item">
														...
														<ul class="view_dt_job">
															<li>
																<div class="vw1254"><i class="far fa-clock"></i>5
																	hours left</div>
															</li>
														</ul>
														<div class="bid_dt12">
														...
														<div class="btn_link23">
															<button class="apled_btn60"><span
																	class="badge badge-light">3</span>Bidders</button>
															<a href="#" class="edit_icon1"><i
												...
												<li>
													<div class="applied_item">
														...
														<ul class="view_dt_job">
															<li>
																<div class="vw1254"><i class="far fa-clock"></i>6
																	days 5 hours left</div>
															</li>
														</ul>
														<div class="bid_dt12">
															<div class="bid_dt13">
														...
														<div class="btn_link23">
															<button class="apled_btn60"><span
																	class="badge badge-light">6</span>Bidders</button>
															<a href="#" class="edit_icon1"><i
																	class="far fa-edit"></i></a>
															<a href="#" class="delete_icon1"><i
																	class="far fa-trash-alt"></i></a>
												...
												<li>
													<div class="applied_item">
														...
														<ul class="view_dt_job">
															<li>
																<div class="vw1254"><i class="far fa-clock"></i>8
																	days 2 hours left</div>
															</li>
														</ul>
														<div class="bid_dt12">
															<div class="bid_dt13">
														...
														<div class="btn_link23">
															<button class="apled_btn60"><span
																	class="badge badge-light">8</span>Bidders</button>
															<a href="#" class="edit_icon1"><i
																	class="far fa-edit"></i></a>
															<a href="#" class="delete_icon1"><i
																	class="far fa-trash-alt"></i></a>
															...
															<div class="col-xl-7">
																<div class="applied_candidates_dt">
																	...
																	<div class="candi_dt">
																		...
																		<div class="candi_cate">Front End Developer
																		</div>
																		<div class="rating_candi">Rating
																			<div class="star">
																				<i class="fas fa-star"></i>
															...
															<div class="col-xl-7">
																<div class="applied_candidates_dt">
																	...
																	<div class="candi_dt">
																		...
																		<div class="candi_cate">Wordpress Developer
																		</div>
																		<div class="rating_candi">Rating
																			<div class="star">
																				<i class="fas fa-star"></i>
													...
													<div class="col-lg-12">
														<div class="form-group">
															...
															<div
																...
																<div class="menu transition hidden"
																	tabindex="-1">
																	<div class="item selected" data-value="hp1">
																		Hourly Price</div>
																	<div class="item selected" data-value="fp2">
																		Fixed Price</div>
																</div>
															</div>
														</div>
