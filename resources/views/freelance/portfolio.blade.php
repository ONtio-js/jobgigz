			...
			<div class="col-lg-9 col-md-8 mainpage">
				...
				<div class="portfolio_heading">
					...
					<div class="portfolio_right">
						<button class="add_portfolio_btn" type="button" data-toggle="modal"
							data-target="#addportfolioModal">Add Portfolio</button>
					</div>
				</div>
				<div class="dsh150">
					<div class="row">
									...
									<div class="portfolio_overlay">
										<div class="overlay_items">
											<a href="#" target="_blank"><i
													class="fas fa-external-link-alt"></i>Live Preview</a>
											<button class="delete_portfolio_btn"><i
													class="far fa-trash-alt"></i></button>
										</div>
									</div>
								</div>
								<div class="portfolio_title"><i class="fas fa-image"></i>Portfolio Name Here</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="portfolio_item">
