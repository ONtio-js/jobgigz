							...
							<div class="request-users">
								<div class="user-request-dt">
									...
									<div class="dash_noti">
										...
										<p>applied for a <a href="#" class="noti-p-link">Php Developer</a>.
										</p>
									</div>
								</div>
						...
						<div class="user-request-list">
							<div class="request-users">
								<div class="user-request-dt">
									...
									<div class="dash_noti">
										<p class="mt-2">Your job listing<a href="#"
												class="noti-p-link">Wordpress Developer</a>is expiring.</p>
									</div>
								</div>
								<div class="time5">2 min ago</div>
							</div>
							...
							<div class="request-users">
								<div class="user-request-dt">
									...
									<div class="dash_noti">
										...
										<p>placed a bid on your <a href="#" class="noti-p-link">I Need
												Travel Wordpress Theme</a>project.</p>
									</div>
								</div>
								<div class="time5">2 min ago</div>
							</div>
							...
							<div class="request-users">
								<div class="user-request-dt">
									...
									<div class="dash_noti">
										...
										<p>hired you for a<a href="#" class="noti-p-link">Web App
												Development</a>project.</p>
									</div>
								</div>
								<div class="time5">2 min ago</div>
							</div>
							...
							<div class="request-users">
								<div class="user-request-dt">
									...
									<div class="dash_noti">
										...
										<p>left you a rating after finish a<a href="#"
												class="noti-p-link">Real Estate Wordpress</a>project.</p>
									</div>
								</div>
								<div class="time5">2 min ago</div>
							</div>
							...
							<div class="request-users">
								<div class="user-request-dt">
									...
									<div class="dash_noti">
										...
										<p>accpted your bid on<a href="#" class="noti-p-link">Hotel Andriod
												App</a>project.</p>
									</div>
								</div>
								<div class="time5">2 min ago</div>
