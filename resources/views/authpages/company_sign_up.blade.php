                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="label15">Profile Avtar <span style="color: red">*</span></label>
                                        <div class="avtar_dp">
                                ...
                                {{-- <div class="col-lg-6">
									...
									<div class="smm_input">
										<input type="text" class="job-input datepicker-here"
											data-language="en" placeholder="Select Launch Date" name="launchdate">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="label15">About Description<span style="color: red">*</span></label>
