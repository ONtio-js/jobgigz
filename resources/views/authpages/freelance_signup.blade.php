                    ...
                    <div class="post501">
                        <form action="{{ route('freelance-store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="label15">First Name<span style="color: red">*</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="label15">Last Name<span style="color: red">*</span></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="job-input" placeholder="Enter Your Password"
								...
								<div class="form-group">
									...
									<div class="smm_input">
										<input type="text" class="job-input datepicker-here"
											data-language="en" placeholder="Enter Your Birth Date">
								...
								<div class="form-group">
									...
									<div class="ui fluid search selection dropdown skills-search">
										...
										<div class="menu transition hidden" tabindex="-1">
											...
											<div class="item selected" data-value="Availability3">Not Available
											</div>
										</div>
									</div>
								</div>
