		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="post501">
					...
					<form action="{{route('jobs.update',$id->id)}}" method="POST" enctype="multipart/form-data">
						@csrf
						@method('patch')
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									<label class="label15">Job Title<span style="color: red">*</span></label>
									<input type="text" class="job-input" placeholder="Job Name Here" name="title" value="{{$id->title}}">
									@error('title')
								...
								<div class="form-group">
									...
									<textarea class="textarea_input" placeholder="Type Description" name="description">{{$id->description}}</textarea>
								</div>
								@error('description')
								<span style="color: red">{{ $message }}</span>
								@enderror
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="ui fluid search selection dropdown skills-search">
										<input name="avaliability" type="hidden" value="{{$id->avaliability}}">
										<i class="dropdown icon"></i>
										<input class="search" autocomplete="off" tabindex="0" >
										<span class="sizer" style=""></span>
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="ui fluid search selection dropdown skills-search">
										<input name="experiencelevel" type="hidden" value="{{$id->experiencelevel}}">
										<i class="dropdown icon"></i>
										<input class="search" autocomplete="off" tabindex="0" >
										<span class="sizer" style=""></span>
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="smm_input">
										<input type="text" class="job-input" placeholder="Min" name="salarymin" value="{{$id->salarymin}}">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="smm_input">
										<input type="text" class="job-input" placeholder="Max" name="salarymax" value="{{$id->salarymax}}">
										<div class="mix_max">Usd</div>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="smm_input">
										<input type="text" class="job-input" placeholder="Type Address" name="location" value="{{$id->location}}">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="ui fluid search selection dropdown skills-search">
										<input name="languages" type="hidden" value="{{$id->languages}}">
										<i class="dropdown icon"></i>
										<input class="search" autocomplete="off" tabindex="0" >
										<span class="sizer" style=""></span>
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="ui fluid multiple search selection dropdown skills-search">
										<input name="skills" type="hidden" value="{{$id->skills}}">
										<i class="dropdown icon"></i>
								...
								<div class="form-group">
									...
									<div class="image-upload-wrap1">
										<input class="file-upload-input1" id="file2" type="file"
											onchange="readURL(this);" accept="image/*" name="file" value="images/homepage/latest-jobs/{{$id->filepath}}">
