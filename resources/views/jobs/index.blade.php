					...
					<div class="res-tabs">
						<div class=" mtab-left">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item">
									<a href="#tab-1" class="nav-link active" data-toggle="tab">Newest
										Jobs</a>
								</li>
								<li class="nav-item">
						...
						<div class=" mtab-right">
							<ul>
								...
								<li class="grid-list">
									<button class="gl-btn" id="grid"><i
											class="fas fa-th-large"></i></button>
									<button class="gl-btn" id="list"><i
									...
									<div class="job-item mt-30">
										<div class="job-top-dt">
											<div class="job-left-dt">
												<img src="images/homepage/latest-jobs/{{$job->file_path}}" alt="">
												<div class="job-ut-dts">
													<a href="#">
														<h4>{{$job->company_auth->companyname}}</h4>
													</a>
													<span><i class="fas fa-map-marker-alt"></i> {{$job->location}}</span>
												</div>
											</div>
											<div class="job-right-dt">
												<div class="job-price">${{$job->salarymax}}</div>
												<div class="job-fp">{{$job->avaliability}}</div>
											</div>
										</div>
										...
										<div class="job-buttons">
											<ul class="link-btn">
												<li><a href="{{route('apply',$job->id)}}" class="link-j1" title="Apply Now">APPLY
														NOW</a></li>
												<li><a href="{{route('jobs.show',$job->id)}}" class="link-j1"
														title="View Job">View Job</a></li>
												<li class="bkd-pm">
													@if (session()->get('details.companyId'))
													<a href="{{route('jobs.edit',$job->id)}}"><button class="bookmark1"
														title="bookmark"><i class="fas fa-pen"></i></button></a>
													@else
													<button class="bookmark1"
														title="bookmark"><i class="fas fa-heart"></i></button>
													@endif
												</li>
											</ul>
										</div>
								...
								<div class="lg-item col-lg-6 col-xs-6 grid-group-item1">
									<div class="job-item mt-30">
										<div class="job-top-dt">
											...
											<div class="job-right-dt">
												<div class="job-price">${{$job->salarymin}}</div>
